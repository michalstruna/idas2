...
DROP TABLE sem_predm_plan CASCADE CONSTRAINTS;
...
DROP TABLE sem_semestr CASCADE CONSTRAINTS;

DROP TABLE sem_stud_plan CASCADE CONSTRAINTS;
...
CREATE TABLE sem_predm_plan (
    id                 INTEGER NOT NULL,
    pocet_studentu     INTEGER NOT NULL,
    rocnik             INTEGER NOT NULL,
    kategorie_id       INTEGER NOT NULL,
    studijni_plan_id   INTEGER NOT NULL,
...
CREATE TABLE sem_semestr (
    id      INTEGER NOT NULL,
    nazev   VARCHAR2(50 CHAR) NOT NULL
);

ALTER TABLE sem_semestr ADD CONSTRAINT sem_semestr_pk PRIMARY KEY ( id );

CREATE TABLE sem_stud_plan (
    id               INTEGER NOT NULL,
    nazev            VARCHAR2(50 CHAR) NOT NULL,
...
ALTER TABLE sem_stud_plan ADD CONSTRAINT sem_obor_pkv3 PRIMARY KEY ( id );

CREATE TABLE sem_uci (
    id              INTEGER NOT NULL,
    ucitel_id       INTEGER NOT NULL,
    role_id         INTEGER NOT NULL,
    predm_plan_id   INTEGER NOT NULL
);

ALTER TABLE sem_uci ADD CONSTRAINT sem_uci_pk PRIMARY KEY ( id );

ALTER TABLE sem_uci
    ADD CONSTRAINT sem_uci__un UNIQUE ( ucitel_id,
    role_id,
    predm_plan_id );
...
ALTER TABLE sem_uzivatel ADD CONSTRAINT sem_uzivatel__un UNIQUE ( email );
...
ALTER TABLE sem_predm_plan
    ADD CONSTRAINT sem_predm_obor_stud_plan_fk FOREIGN KEY ( studijni_plan_id )
        REFERENCES sem_stud_plan ( id );

ALTER TABLE sem_predm_plan
    ADD CONSTRAINT sem_predm_plan_semestr_fk FOREIGN KEY ( semestr_id )
        REFERENCES sem_semestr ( id );
...
ALTER TABLE sem_stud_plan
    ADD CONSTRAINT sem_stud_plan_obor_fk FOREIGN KEY ( obor_id )
        REFERENCES sem_obor ( id );

ALTER TABLE sem_uci
    ADD CONSTRAINT sem_uci_sem_predm_plan_fk FOREIGN KEY ( predm_plan_id )
        REFERENCES sem_predm_plan ( id );
...
ALTER TABLE sem_zpus_predm
    ADD CONSTRAINT sem_zpus_predm_predm_plan_fk FOREIGN KEY ( predm_plan_id )
        REFERENCES sem_predm_plan ( id );
...
DROP SEQUENCE SEM_PREDM_PLAN_SEQ;
...
DROP SEQUENCE SEM_STUDIJNI_PLAN_SEQ;

DROP SEQUENCE SEM_SEMESTR_SEQ;
...
CREATE SEQUENCE SEM_PREDM_PLAN_SEQ
START WITH 1
INCREMENT BY 1;
...
CREATE SEQUENCE SEM_STUDIJNI_PLAN_SEQ
START WITH 1
INCREMENT BY 1;

CREATE SEQUENCE SEM_SEMESTR_SEQ
START WITH 1
INCREMENT BY 1;