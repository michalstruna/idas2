 ...
 */
class TableImageControl extends Control {
     ...
     */
    public function render(array $items, bool $editable, $imageColumn, array ...$columns): void {
        $template = $this->template;
        $template->setFile(__DIR__ . '/templates/tableImageControl.latte');
        $template->items = $items;
        $template->editable = $editable;
        $template->imageColumn = $imageColumn;
